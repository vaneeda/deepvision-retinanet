...
def getPartialInstances(framedict):
    """
    for each object in framedict, return True if object overlaps with other object
    """
...
def create_framework(framedict):
    ...
    # Check if objects are partial (in this case, we only look if object overlaps with other object)
...
if __name__ == '__main__':
    ...
    input_xml_path =    r"/temp/deepvision.xml"
    output_file_path =  r"/temp/deepvision_updated.xml"
    csv_input_path =    r"/temp/deepvision.csv"
